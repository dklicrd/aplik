...
INSERT INTO products (id, name, category, stock, min_stock, unit, price_neto, price_bruto) VALUES
  (1, 'Vara de 8 a 16', 'herramienta', 3, 5, 'unidad', 0, 0),
  (2, 'Tubos Sellador Polyflex', 'producto', 91, 20, 'tubo', 0, 0),
  (3, 'Silicone Natural Ultra Clear', 'producto', 0, 5, 'unidad', 0, 0),
  (4, 'Rollo Lona 4mm', 'herramienta', 32, 5, 'rollo', 0, 0),
  (5, 'Porta Rolos Extrafuerte', 'herramienta', 3, 3, 'unidad', 0, 0),
  (6, 'Piedra de Pulir', 'herramienta', 0, 5, 'unidad', 0, 0),
  (7, 'Motas Rugosas', 'herramienta', 6, 5, 'unidad', 0, 0),
  (8, 'Motas Pequeñas Finas', 'herramienta', 0, 5, 'unidad', 0, 0),
  (9, 'Motas Extra Rugosa', 'herramienta', 0, 5, 'unidad', 0, 0),
  (10, 'Motas Anti Gota Lanco', 'herramienta', 0, 5, 'unidad', 0, 0),
  (11, 'Malla de Refuerzo', 'producto', 1, 5, 'unidad', 0, 0),
  (12, 'Gal Varsol', 'producto', 5.5, 3, 'galón', 0, 0),
  (13, 'Gal Semigloss Zero 6I3-8', 'pintura', 0, 3, 'galón', 0, 0),
  (14, 'Gal Seal Coat SW-6080', 'pintura', 0, 3, 'galón', 0, 0),
  (15, 'Gal Seal Coat Lino', 'pintura', 0, 3, 'galón', 0, 0),
  (16, 'Gal Seal Coat Arena del Sur', 'pintura', 0, 3, 'galón', 0, 0),
  (17, 'Gal Masilla Crack Filler', 'producto', 1, 3, 'galón', 0, 0),
  (18, 'Gal Lucidux Limpia Parabrisas', 'producto', 1, 2, 'galón', 0, 0),
  (19, 'Gal Galvacon', 'producto', 0, 3, 'galón', 0, 0),
  (20, 'Gal Durex 6L2-4 Gris', 'pintura', 0, 2, 'galón', 0, 0),
  (21, 'Gal Durex 1P3-7 Azul Claro', 'pintura', 0, 2, 'galón', 0, 0),
  (22, 'Gal Durex 1F3-8 Naranja Oscuro', 'pintura', 0, 2, 'galón', 0, 0),
  (23, 'Gal Durex 1C2-8 Rosado', 'pintura', 0, 2, 'galón', 0, 0),
  (24, 'Gal Durex 1A1-8 Morado', 'pintura', 0, 2, 'galón', 0, 0),
  (25, 'Gal Dry Coat', 'producto', 0, 2, 'galón', 0, 0),
  (26, 'Gal Citrus Cleaner', 'producto', 0, 2, 'galón', 0, 0),
  (27, 'Gal CB-Crete', 'producto', 4, 3, 'galón', 0, 0),
  (28, 'Express Lino Natural', 'pintura', 0, 3, 'cubeta', 0, 0),
  (29, 'Espátula Plástica', 'herramienta', 0, 5, 'unidad', 0, 0),
  (30, 'Espátula de Rosca', 'herramienta', 0, 5, 'unidad', 0, 0),
  (31, 'Cub Urethanizer', 'producto', 0, 3, 'cubeta', 0, 0),
  (32, 'Cub Ultra Siliconizer', 'producto', 0, 3, 'cubeta', 0, 0),
  (33, 'Cub Total Duna', 'pintura', 6, 3, 'cubeta', 0, 0),
  (34, 'Cub Total Blanco', 'pintura', 18, 10, 'cubeta', 0, 0),
  (35, 'Cub Texturizada Naranja', 'pintura', 0, 3, 'cubeta', 0, 0),
  (36, 'Cub Texturizada Blanco (Cano)', 'pintura', 0, 3, 'cubeta', 0, 0),
  (37, 'Cub Texturizada Blanco', 'pintura', 0, 3, 'cubeta', 0, 0),
  (38, 'Cub Texturizada Arena del Sur', 'pintura', 8, 5, 'cubeta', 0, 0),
  (39, 'Cub Super Track', 'producto', 3, 3, 'cubeta', 0, 0),
  (40, 'Cub Siliconizer Rojo Teja', 'producto', 0, 3, 'cubeta', 0, 0),
  (41, 'Cub Siliconizer 1000', 'producto', 1, 3, 'cubeta', 0, 0),
  (42, 'Cub Siliconizer', 'producto', 0, 5, 'cubeta', 0, 0),
  (43, 'Cub Semigloss Zero 6I3-3', 'pintura', 0, 2, 'cubeta', 0, 0),
  (44, 'Cub Seal Coat Verde Softball', 'pintura', 0, 2, 'cubeta', 0, 0),
  (45, 'Cub Seal Coat SM2-8 Verde Modif.', 'pintura', 2, 3, 'cubeta', 0, 0),
  (46, 'Cub Seal Coat N9-4', 'pintura', 0, 2, 'cubeta', 0, 0),
  (47, 'Cub Seal Coat Castaño', 'pintura', 6, 5, 'cubeta', 0, 0),
  (48, 'Cub Seal Coat Blanco', 'pintura', 0, 3, 'cubeta', 0, 0),
  (49, 'Cub Seal Coat 6L2-7', 'pintura', 2, 3, 'cubeta', 0, 0),
  (50, 'Cub Seal Coat 6L2-6', 'pintura', 1, 3, 'cubeta', 0, 0),
  (51, 'Cub Protecto Coat N8-4 Mindful', 'pintura', 0, 2, 'cubeta', 0, 0),
  (52, 'Cub Protecto Coat Blanco Mate', 'pintura', 2, 3, 'cubeta', 0, 0),
  (53, 'Cub Protecto Coat Arena del Sur', 'pintura', 0, 3, 'cubeta', 0, 0),
  (54, 'Cub Protecto Coat 6L2-4', 'pintura', 0.75, 3, 'cubeta', 0, 0),
  (55, 'Cub Protecto Coat 6J2-4', 'pintura', 1, 3, 'cubeta', 0, 0),
  (56, 'Cub Primer Super', 'producto', 0, 5, 'cubeta', 0, 0),
  (57, 'Cub Primer Sealer', 'producto', 5, 5, 'cubeta', 0, 0),
  (58, 'Cub Preseal', 'producto', 0, 3, 'cubeta', 0, 0),
  (59, 'Cub Microtop', 'producto', 0, 10, 'cubeta', 0, 0),
  (60, 'Cub Maxima Armor 6L2-7', 'pintura', 0, 2, 'cubeta', 0, 0),
  (61, 'Cub Maxima Armor 3R1-8', 'pintura', 0, 2, 'cubeta', 0, 0),
  (62, 'Cub Level Tech', 'producto', 0, 3, 'cubeta', 0, 0),
  (63, 'Cub Express Arena del Sur', 'pintura', 0, 5, 'cubeta', 0, 0),
  (64, 'Cub Express 6L2-4 Gris Sambil', 'pintura', 0, 2, 'cubeta', 0, 0),
  (65, 'Cub Duraflex', 'producto', 0, 5, 'cubeta', 0, 0),
  (66, 'Cub Cover Up Arena del Sur', 'pintura', 0, 3, 'cubeta', 0, 0),
  (67, 'Cub Cemento Plástico', 'producto', 0, 5, 'cubeta', 0, 0),
  (68, 'Cub CB-Crete', 'producto', 0, 3, 'cubeta', 0, 0),
  (69, 'Cub CB 1000', 'producto', 0, 3, 'cubeta', 0, 0),
  (70, 'Cub Aquaproof Wall', 'producto', 0, 3, 'cubeta', 0, 0),
  (71, 'Cub Aquaproof Primer', 'producto', 0, 3, 'cubeta', 0, 0),
  (72, 'Cub Aluminio', 'pintura', 0, 5, 'cubeta', 0, 0),
  (73, 'Cub Acrylflex', 'producto', 0, 3, 'cubeta', 0, 0),
  (74, 'Cinta Multi Seal', 'producto', 0, 5, 'unidad', 0, 0),
  (75, 'Cinta Ever Seal', 'producto', 0, 5, 'unidad', 0, 0),
  (76, 'Caja Masilla Joint Compound', 'producto', 0, 5, 'caja', 0, 0),
  (77, 'Rollo de Malla', 'herramienta', 0, 3, 'rollo', 0, 0);
